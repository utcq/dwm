...
static const char *fonts[]          = { "FiraCode-Regular:size=9", "fontawesome:size=9", "NotoColorEmoji:size=9" };
static const char dmenufont[]       = "FiraCode-Regular:size=9";
//background color
...
static const char col_cyan[]        = "#b14e4e";
